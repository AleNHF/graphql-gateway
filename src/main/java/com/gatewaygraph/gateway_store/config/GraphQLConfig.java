...
import com.gatewaygraph.gateway_store.resolvers.purchases.PurchaseMutationResolver;
import com.gatewaygraph.gateway_store.resolvers.purchases.PurchaseResolver;
...
public class GraphQLConfig {
        ...
        RuntimeWiringConfigurer runtimeWiringConfigurer(UserResolver userResolver,
                        ...
                        ProductMutationResolver productMutationResolver, PurchaseResolver purchaseResolver,
                        PurchaseMutationResolver purchaseMutationResolver) {
                return wiringBuilder -> wiringBuilder
                                .type("Query", typeWiring -> typeWiring
                                                ...
                                                .dataFetcher("purchases", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return purchaseResolver.getAllPurchases();
                                                        }
                                                })
                                                .dataFetcher("purchase",
                                                                env -> purchaseResolver
                                                                                .getPurchaseById(
                                                                                                env.getArgument("id")))
                                                .dataFetcher("brands", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return productResolver.getAllBrands();
                                                        }
                                                })
                                                .dataFetcher("brand",
                                                                env -> productResolver
                                                                                .getBrandById(env.getArgument("id")))
                                                .dataFetcher("sizes", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return productResolver.getAllSizes();
                                                        }
                                                })
                                                .dataFetcher("size",
                                                                env -> productResolver
                                                                                .getSizeById(env.getArgument("id")))
                                                .dataFetcher("colors", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return productResolver.getAllColors();
                                                        }
                                                })
                                                .dataFetcher("color",
                                                                env -> productResolver
                                                                                .getColorById(env.getArgument("id")))
                                                .dataFetcher("models", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return productResolver.getAllModels();
                                                        }
                                                })
                                                .dataFetcher("model",
                                                                env -> productResolver
                                                                                .getModelById(env.getArgument("id")))
                                                .dataFetcher("promotions", new DataFetcher<List<Object>>() {
                                                        @Override
                                                        public List<Object> get(DataFetchingEnvironment environment)
                                                                        throws Exception {
                                                                return productResolver.getAllPromotions();
                                                        }
                                                })
                                ...
                                .type("Mutation", typeWiring -> typeWiring
                                                ...
                                                .dataFetcher("updateProduct", env -> {
                                                        ...
                                                        JsonNode inputJsonNode = objectMapper.valueToTree(inputMap);
                                                        String jsonString = inputJsonNode.toString();
                                                        return productMutationResolver.updateProduct(productId,
                                                                        jsonString);
                                                })
                                                .dataFetcher("deleteProduct", env -> productMutationResolver
                                                                .deleteProduct(env.getArgument("id")))
                                                .dataFetcher("createPurchase", env -> {
                                                        Map<String, Object> inputMap = env.getArgument("input");
                                                        ObjectMapper objectMapper = new ObjectMapper();
                                                        JsonNode inputJsonNode = objectMapper.valueToTree(inputMap);
                                                        String jsonString = inputJsonNode.toString();
                                                        return purchaseMutationResolver.createPurchase(jsonString);
                                                })
                                                .dataFetcher("updatePurchase", env -> {
                                                        String purchaseId = env.getArgument("id");
                                                        Map<String, Object> inputMap = env.getArgument("input");
                                                        ObjectMapper objectMapper = new ObjectMapper();
                                                        JsonNode inputJsonNode = objectMapper.valueToTree(inputMap);
                                                        String jsonString = inputJsonNode.toString();
                                                        return purchaseMutationResolver.updatePurchase(purchaseId,
                                                                        jsonString);
                                                })
                                                .dataFetcher("deletePurchase", env -> purchaseMutationResolver
                                                                .deletePurchase(env.getArgument("id")))
